...
const expectedMaterialSignature = [
  -57.1, -0.1, -1.6, 3, 41.9, 5.4, -9.8, 16.6, -89, 9.9, -3.5, -20.2, 31.6,
  -6.1, -17.4, 4.5, -67.4, 7.9, -4.2, -22.1, 28.3, -13.8, -26.5, 3.4,
];

const expectedFacetSignature = [
  1.06, -1.39, 1.37, 1.41, 1.38, 1.3, 1.19, 1.41, -1.34, 0.93, -0.36, -0.62,
  -0.4, -0.16, 0.07, -0.61, 0.28, 0.46, -1, -0.79, -0.97, -1.14, -1.26, -0.8,
];
