...
const expectedMaterialSignature = [
  -51.7, 2.5, 0.9, 6.3, 45.4, 8.2, -6.6, 22.3, -82.7, 12.3, -1.1, -15.9, 35.6,
  -2.9, -13.6, 11, -62, 10, -2.1, -18.4, 31.7, -10.6, -22.5, 9.3,
];

const expectedFacetSignature = [
  1.07, -1.38, 1.34, 1.41, 1.36, 1.29, 1.17, 1.4, -1.34, 0.96, -0.27, -0.59,
  -0.34, -0.15, 0.1, -0.55, 0.27, 0.41, -1.07, -0.82, -1.02, -1.14, -1.27,
  -0.85,
];
